...
namespace Destructible2D.Inspector
{
	...
	public class D2dDestructibleSprite_Editor : D2dDestructible_Editor<D2dDestructibleSprite>
	{
		protected override void OnInspector()
		{
			...
			DrawDefault("cropSprite", ref updateSprite, "Enable this if you want the attached SpriteRenderer.sprite to automatically crop to the AlphaTex boundary, reducing the fill rate requirements for large splitting sprites.");
